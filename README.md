...
It enables SkyrimNet (Chatterbox client), and standard OpenAI TTS clients (Open WebUI, AnythingLLM, etc.) to seamlessly use Zonos 2 with zero code changes.
...
client = OpenAI(
    base_url="http://xxx.local:8000/v1",
    api_key="none"
)

response = client.audio.speech.create(
    model="zonos2",
    input="[laughter] Hello！"
)
